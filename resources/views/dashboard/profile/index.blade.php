                        ...
                        <div class="col-md-12">
                            <form action="{{ route('profile.store') }}" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="code">Phone Number Code</label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="mobile">Phone Number (Without Country code)</label>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <input type="submit" class="btn btn-primary" value="Update User Record">
                                        </div>
                                    </div>
                                </div>
