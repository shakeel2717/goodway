...
$(document).ready(function() {
    setTimeout(function() {
        ...
        Morris.Bar({
            ...
            barColors: ["#4886ff", "#7759de", "#7ad835"]
        });
        ...
        Morris.Bar({
            ...
            ykeys: ['a', 'b', 'c'],
            labels: ['Bar 1', 'Bar 2', 'Bar 3'],
            barColors: ["#fa7d03", "#ff484c", "#4886ff"]
        });
        ...
        Morris.Area({
            ...
            lineColors: ['#7ad835', '#7759de', '#4886ff'],
            xkey: 'period',
        ...
        var graph_real = Morris.Line({
            ...
            ymin: -1.0,
            ymax: 1.0,
            lineColors: ['#fa7d03', '#ff484c', '#4886ff'],
            pointSize: 4,
            responsive: true,
            pointFillColors: ['#fff', '#fff', '#fff'],
            pointStrokeColors: ['#fa7d03', '#ff484c', '#4886ff'],
            lineWidth: 2,
            hideHover: true
        });
